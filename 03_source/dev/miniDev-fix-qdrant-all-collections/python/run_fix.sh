#!/bin/bash
# Qdrant Fixer - Скрипт запуска для Linux/Mac
# Массовое исправление indexing_threshold коллекций
...
# Запускаем qdrant_fixer с переданными параметрами
$PYTHON_CMD qdrant_fixer.py "$@"
